...
export const RegistrationPage = () => {
  return (
    <div className="flex w-full items-center justify-center rounded-4xl border shadow-lg">
      <div className="bg-light-active flex w-96 flex-col items-center justify-center gap-y-3 rounded-lg px-4 py-6">
